...
//        VaRPortfolioCalc varCalculator = new ParametricVaRCalculator(BATCH_SIZE, VAR_CI);
        ...
        while (i < totalEvents) {
            ...
            if (i < (BATCH_SIZE + 1) * NUMBER_OF_ASSETS) {
                varCalculator.addEvent(list.get(i));
                i++;
            } else {
    ...
    public ArrayList<Object[]> readBacktestData() throws FileNotFoundException {
        ...
        Scanner scan = new Scanner(new File("/home/dilini92/Sem7/siddhi/modules/siddhi-extensions/var/src/main/resources/BackTestDataReal.csv"));
